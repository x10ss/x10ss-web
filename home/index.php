...
<body>
  ...
  <div class="col-md-10">
   ...
   <div class="col-md-4">
	...
	<b>
	template pack
	<img style="vertical-align:middle; margin:0px 3px;" width="20px" src="https://extensionless.com/images/trophy.svg"/>
	rank 1
	</b>	
	</small>
	</p> 
	...
	<a class="chop" style="color:tomato" href="https://catalog.extensionless.com/community/?page=1&order=ratings&direction=desc">
	<small class="chop">

	<small style="vertical-align: middle; font-size:20px;" class="vimh" title="4 likes">
	4<img style="vertical-align:middle;" width="18px" src="https://extensionless.com/images/like.svg"/> 
	</small>
	<span class="vimh">
	2doprvak
	</span>
	
	<img style="float:right; margin-right: 5px;margin-top:-20%x; vertical-align:middle;" src="images/community-active.svg" width="18px"/>
...
<b>
latest
<img style="margin:0px 5px; vertical-align:middle;" width="20px" src="https://extensionless.com/images/newspaper.svg"/>
news
</b>
</small>
...
window.location="https://www.support.extensionless.com/news/";	});
...
<hr/>
	...
	$('#android-app').click(function (){
		window.location='https://support.extensionless.com/news/android-app';
	});
	</script>
	</div>
...
' id='extensionless-beta' style='text-align:center;border-bottom: 1px dotted tomato; '>
	...
	$('#extensionless-beta').click(function (){
		window.location='https://support.extensionless.com/news/extensionless-beta';
	});
	</script>
	</div>
...
APPLICATION SIZE: 88 MB' id='v-1-0-0-0-release-notes' style='text-align:center;border-bottom: 1px dotted tomato; '>
	...
	$('#v-1-0-0-0-release-notes').click(function (){
		window.location='https://support.extensionless.com/news/v-1-0-0-0-release-notes';
	});
	</script>
	</div>
