	...
	a free <img style="vertical-align:middle;" height="25px" src="https://www.extensionless.com/images/file.svg"/>
	file
	extension
	<img style="vertical-align:middle;" width="30px" src="https://www.extensionless.com/images/utility.svg"/>
	utility
	for <img style="vertical-align:middle;" width="25px" src="https://www.extensionless.com/images/windows.svg"/>
	windows
	</h2>
	<hr/>
	<a id="download-current-setup-version" style="display:inline;" title="download setup.exe" href="https://download.extensionless.com/setup.exe">
		<p style="padding:17px; background-color: tomato; text-align:center; color:white;" class="chop">
			<img title="download" style="vertical-align:middle; width:25px;" src="https://www.extensionless.com/images/cloud-download-alt.svg"/>
			download setup.exe
